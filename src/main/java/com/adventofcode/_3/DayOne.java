...
import com.adventofcode.util.InputUtil;
...
public class DayOne {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine()) {
            ...
            String[] compartmentContents = InputUtil.divideStringIntoEqualSubstrings(line, line.length()/2);
            String equalItemType = InputUtil.pickOneEqualValueOfTwoSequences(compartmentContents[0], compartmentContents[1]);
